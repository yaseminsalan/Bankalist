...
class BankaDetayViewController: UIViewController {
    ...
    var titles:[String] = ["The name of the Bank".localized(),"Bank's Address".localized(),"Bank Type".localized(),"Bank Status".localized(),"Nearest ATM".localized()];
    var subtitles:[String] = []
    let prices = ["", "", "","","Get Directions".localized()]
