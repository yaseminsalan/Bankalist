                ...
                Timer.scheduledTimer(withTimeInterval: 5.0, repeats: true) { timer in
                    ...
                    if Connectivity.isConnectedToInternet() == true {
                       // timer.invalidate()
                        ...
                        //timer.invalidate()
                        let alert = UIAlertController(title: "İnternet bağlantısı yok", message: "Cihazınızın internete bağlı olduğundan emin olun", preferredStyle: UIAlertController.Style.alert)
                   ...
                   request.responseJSON { (data) in
                       ...
                       case .success(let value):
                           ...
                           self.tableview.reloadData()
                               ...
                               let alert = UIAlertController(title: "Uyarı", message: "Şuan Banka Bilgisi Bulunmamaktadır.", preferredStyle: UIAlertController.Style.alert)
                               alert.addAction(UIAlertAction(title: "Tamam", style: UIAlertAction.Style.default, handler: nil))
                               self.present(alert, animated: true, completion: nil)
                           }
                           
                       case .failure(let error):
                           let alert = UIAlertController(title: "HATA", message: "Şuan Bir Hata Oluştu.Lütfen Data Sonra Tekrar Deneyin.", preferredStyle: UIAlertController.Style.alert)
                           alert.addAction(UIAlertAction(title: "Tamam", style: UIAlertAction.Style.default, handler: nil))
                           self.present(alert, animated: true, completion: nil)
                       }
                   }
                ...
                if filterdata.count != 0 || filterEmptyControl{
                   ...
                   if filterdata.count == 0 {
                    ...
                    if cancelControl {
                        ...
                        print("filter boyut \(filterdata.count)")
